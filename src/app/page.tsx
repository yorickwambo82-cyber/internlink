  ...
  return (
    <header className="sticky top-0 z-50 w-full border-b border-white/5" style={{ background: 'rgba(5, 13, 10, 0.85)', backdropFilter: 'blur(16px)', WebkitBackdropFilter: 'blur(16px)' }}>
      <div className="w-full px-4 sm:px-6 lg:px-8 py-4 flex items-center justify-between">
        ...
        >
          <div className="w-9 h-9 rounded-xl bg-white shadow-lg shadow-emerald-900/50 group-hover:shadow-emerald-500/30 transition-shadow flex items-center justify-center p-0.5">
